...
#Print correlation coefficient for all the above colunms
data1_numeric.corr()
...
# - The next higher correlation strength is observed between solar and wind(-0.055874)
...
#CREATING DUMMY FOR WEATHER column
